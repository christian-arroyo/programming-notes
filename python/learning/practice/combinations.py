# Given two integers n and k, find all the possible unique combinations of
# k numbers in range 1 to n
...
def combinations(n: int, k: list) -> list:
    ...
    def backtrack(start, current_combination):
        ...
        if len(current_combination) == k:
            # Add a copy, not a referance to the object that will be modified
            # in other iterations
